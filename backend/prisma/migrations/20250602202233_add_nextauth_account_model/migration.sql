...
*/
-- DropIndex
DROP INDEX "user_providers_provider_providerUserId_key";
...
INSERT INTO "new_users" ("createdAt", "email", "id", "isActive", "name", "updatedAt") SELECT "createdAt", "email", "id", "isActive", "name", "updatedAt" FROM "users";
DROP TABLE "users";
