...
Мне очень хотелось иметь в архитектуре упорядоченность, модульность и DI от NestJs, при этом для современного frontend просто необходим SSR, SSG, Router (NextJs), и конечно же typesafe коммуникация между ними.
